using DVLD_Business;
using DVLD_Pro.Licenses;
using DVLD_Pro.Licenses.Local_Licenses;
using DVLD_Pro.Tests;
using System;
    ...
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void showLicenseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int LicenseID = clsLocalDrivingLicenseApplication.
                FindByLocalDrivingAppLicenseID(LocalDrivingLicenseApplicationID).GetActiveLicenseID();
